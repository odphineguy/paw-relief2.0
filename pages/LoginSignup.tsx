        ...
        <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark">
            ...
            <div className="flex-1 bg-white dark:bg-gray-900 rounded-t-3xl -mt-6 p-6 shadow-lg">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">
                    {isForgotPassword ? 'Reset Password' : isSignUp ? 'Create Account' : 'Welcome to Paw Relief'}
                </h1>
                ...
                {successMessage && (
                    <div className="mb-4 p-4 bg-green-100 dark:bg-green-900/30 border border-green-400 dark:border-green-700 rounded-lg text-green-700 dark:text-green-400 text-sm">
                    ...
                    <>
                        ...
                        <div className="flex flex-col gap-3">
                            <button
                                ...
                                className="flex items-center justify-center gap-3 p-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
