                                ...
                                <div className="p-6 space-y-5">
                                    ...
                                    <div className="flex space-x-3">
                                        <button
                                            ...
                                            className="flex-1 bg-primary text-white px-4 py-3 rounded-xl font-bold text-base hover:bg-primary/90 transition-colors flex items-center justify-center space-x-2 shadow-lg shadow-primary/30"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="flex-1 bg-red-500 text-white px-4 py-3 rounded-xl font-bold text-base hover:bg-red-600 transition-colors flex items-center justify-center space-x-2 shadow-lg shadow-red-500/30"
                                        >
                                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
